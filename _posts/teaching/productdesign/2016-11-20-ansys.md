...
The model file of the brake can be downloaded [here (.agbd)][agbd] (the raw models are [here (.igs)][igs] or [here (.stp)][stp]). 
 ...
 * Right click Static Structural -> Insert -> Remote Displacement -> Set values as shown
