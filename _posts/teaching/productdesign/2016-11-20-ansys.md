...
Now hit *** and brew your coffee. Depending on how many samples you requested, it will
...
<img src="/_images/tutorial_ansys/sensitivity2.png" alt="Drawing" style="height: 400px;"/> 
...
<img src="/_images/tutorial_ansys/sensitivity3.png" alt="Drawing" style="height: 400px;"/> 
...
OK. That's a lot of talking. Now let's do some practice. You can either use your own model, 
 or follow the brake design problem. The model files can be downloaded [here (.igs)][igs] or [here (.stp)][stp]. All credits go
 to A. Durgude, A. Vipradas, S. Kishore, and S. Nimse (see their [MAE598 Design Optimization project report (2016)][report]).
...
* Set up an optimization problem. Once done, compare your optimal design against the original one (e.g., see
