...
### Description of the brake design problem
...
### Setting up the output and input parameters
The output parameters are the design attributes computed through simulations - static structural, modal, and thermal
in this case. The following sections describes how these simulations are set up.

#### Static structural setup
 * Create geometry in DesignModeler or import a agdb file. Import this file in the DesignModeler and click "Generate".
 * Double click on Model to setup the mesh: Right click Mesh -> Method -> Select all the bodies and then select Tetrahedrons in Method option
 ...
 * Right click Static Structural -> Insert -> Rotational Velocity -> Set 250 rad/s to the y-axis of the brake disk
 ...
 * Right click Static Structural -> Insert -> Pressure -> Enter the values as shown by selecting the outer brake pad faces. Do this for each outer brake pad face.
 
 <img src="/_images/tutorial_ansys/structural4.png" alt="Drawing" style="height: 200px;"/> 
 
 * Right click Static Structural -> Insert -> Displacement -> Fix x- and z-axis displacement of all the faces of brake pads
 
 <img src="/_images/tutorial_ansys/structural5.png" alt="Drawing" style="height: 300px;"/> 

 * Right click Static Structural -> Insert -> Displacement -> Fix y-axis displacement of all the faces of brake disk
 
 <img src="/_images/tutorial_ansys/structural51.png" alt="Drawing" style="height: 300px;"/> 
 <img src="/_images/tutorial_ansys/structural52.png" alt="Drawing" style="height: 300px;"/> 
...
### Step 4: Create a response surface
...
Having too few will cause overfitting, and having too many will leave too few data for model training.

<img src="/_images/tutorial_ansys/verification.png" alt="Drawing" style="height: 400px;"/> 

In academia and industries related to engineering design, you can see the term "V&V", 
which stands for "Verification and Validation". What's the 
difference between the two? "Validation" is often referred to as testing a design in reality (with experiments) while
